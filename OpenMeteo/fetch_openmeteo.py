...
try:
    ...
    for row in rows:
        ...
        plt.title(f'Denná teplota - 2 metre nad zemou - zastávka {town}, {stop_name}')
        plt.xlabel('Dátum')
        ...
        plt.title(f'Denný súčet zrážok - zastávka {town}, {stop_name}')
        plt.xlabel('Dátum')
        ...
        plt.title(f'Denná rýchlosť vetra - zastávka {town}, {stop_name}')
        plt.xlabel('Dátum')
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.legend()
